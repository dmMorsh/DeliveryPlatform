...
namespace DeliveryService.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260316160000_Auto_20260316185943_DeliveryDbContext")]
    partial class Auto_20260316185943_DeliveryDbContext
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Shared.Contracts.ProcessedCommand", b =>
                {
                    ...
                    b.ToTable("ProcessedCommands", "delivery");
                });

            modelBuilder.Entity("DeliveryService.Domain.Aggregates.Delivery", b =>
                {
                    b.OwnsMany("DeliveryService.Domain.Entities.DeliveryAssignmentAttempt", "AssignmentAttempts", b1 =>
                        {
                            b1.Property<Guid>("Id")
                                .HasColumnType("uuid");
